...
public class DataUsuario
{
    ...
    public List<EncapsulateUsuario> leerUsuario()
    {
        List<EncapsulateUsuario> listUsuario = new List<EncapsulateUsuario>();
        DataTable dataUsuario = new DataTable();
        NpgsqlConnection conection = new NpgsqlConnection(ConfigurationManager.ConnectionStrings["Postgres"].ConnectionString);
        ...
        try
        {
            NpgsqlDataAdapter dataAdapter = new NpgsqlDataAdapter("usuario.f_leer_usuario", conection);
            dataAdapter.SelectCommand.CommandType = CommandType.StoredProcedure;
    ...
    public bool editarUsuario(EncapsulateUsuario usuario)
    {
        DataTable dataUsuario = new DataTable();
        NpgsqlConnection conection = new NpgsqlConnection(ConfigurationManager.ConnectionStrings["Postgres"].ConnectionString);
        Boolean respuesta = false;
